...
namespace luval.recorder.client
{
    /// <summary>
    ...
    public class ConsoleSwitches
    {
        ...
        public string SessionName
        {
            get
            {
                if(string.IsNullOrWhiteSpace(this["/session"])) return string.Format("{0}-{1}-RECORDING", Environment.MachineName, Environment.UserName);
                return this["/session"];
            }
        }
